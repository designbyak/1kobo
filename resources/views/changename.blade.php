	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<div class="contact100-form">
				...
				Change Username
				<br>
				<p class="m-t-15">You can change your username from here.</p>
				</span>
                ...
                @if ($message = Session::get('success'))
                    ...
                    @endif
				<form class="contact100-form validate-form" method="POST"  action="{{ url('/') }}/change-name/update">
                @csrf
                @method('PUT')
					<div class="wrap-input100 validate-input" data-validate="Username is required">
						<span class="label-input100">New Username</span>
						<input class="input100" type="text" name="name" placeholder="Enter new username here" minlength="3" maxlength="15" autocomplete="off" required>
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<span class="label-input100">Current Password</span>
						<input class="input100" type="password" name="password" placeholder="Enter your password here" minlength="3" maxlength="15" autocomplete="off" required>
						<span class="focus-input100"></span>
					</div>
					<div class="container-contact100-form-btn">
						<div class="wrap-contact100-form-btn">
							<div class="contact100-form-bgbtn"></div>
							<button class="contact100-form-btn" name='btn-changeusername'>
								<span>
									Change Username
