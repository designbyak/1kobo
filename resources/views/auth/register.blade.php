			...
			<div class="contact100-form">
                ...
                @csrf
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						...
						<input class="input100" id="name" class="block mt-1 w-full" type="text" name="name" :value="old('email')" placeholder="Enter your username" minlength="3" maxlength="15" autocomplete="off" required>
						<span class="focus-input100"></span>
					</div>
                    <div class="wrap-input100 validate-input" data-validate="Name is required">
						<span class="label-input100">Your Email</span>
						<input class="input100" id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" placeholder="Enter your email" minlength="3" maxlength="50" autocomplete="off" required>
						<span class="focus-input100"></span>
					</div>
                    ...
                    <div class="wrap-input100 validate-input">
						...
						<input class="input100" id="password"
                                ...
                                required autocomplete="current-password" placeholder="Enter your password again" minlength="3" maxlength="16" autocomplete="off" required>
						<span class="focus-input100"></span>
					</div>
					...
					<p class="p-t-10" align="center"><a href="login">Already Have an Account? Login</a></p>
				</form>
