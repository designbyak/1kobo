...
<html lang="en">
<head>
	<title>Archived Messages - 1kobo</title>
	<meta charset="UTF-8">
		...
		<div class="wrap-contact100">
			<div class="contact100-form">
				<span class="contact100-form-title">
					Archived Answers
				<p>&#128071; Scroll &#128071; down to check out the messages that have been archived</p>
					<div class="m-t-15" style="justify-content:center;" id="adslot">
  <p class="consent m-b-4 respicon">Advertisement</p>
  <!-- 1kobo_ArchivedMessages_Header_Internal_KubNewM1 -->
  <ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-1740040881361415"
     data-ad-slot="2848819805"
     data-ad-format="auto"
     ...
     (adsbygoogle = window.adsbygoogle || []).push({});
                ...
                <div class='answersx noansx'>
						...
						<img src="https://gdpd.xyz/kimages/loader2.gif" alt="Loading..">
                            ...
                            <a href="/report-archive/{{$messages->id}}"><button class="respiconx buttxxx nbutx m-t-3" id="goback" onclick="GoBackBtn()"><i class="fa fa-flag m-r-25" title="Report Response"></i> Report/Spam</button></a>
                            </div>
                            @endforeach
                            </div>
...
@endif
			...
			<hr>
				...
				<a href="/messages" class="back-to-top" id='goback' onclick='GoBackBtn()'></a>
