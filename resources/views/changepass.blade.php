	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<div class="contact100-form">
				...
				Change Password
				<br>
				<p class="m-t-15">You can change your password from here.</p>
				</span>
                ...
                @if ($message = Session::get('success'))
                    ...
                    @endif
				<form class="contact100-form validate-form" method="POST" action="{{ url('/') }}/change-pass/update">
                @csrf
                @method('PUT')
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<span class="label-input100">New Password</span>
						<input class="input100" type="text" name="name" value="{{Auth::user()->name}}" hidden>
						<input class="input100" type="password" name="password" placeholder="Enter new password here" minlength="3" maxlength="15" autocomplete="off" required>
						<span class="focus-input100"></span>
					</div>
					<div class="container-contact100-form-btn">
						<div class="wrap-contact100-form-btn">
							<div class="contact100-form-bgbtn"></div>
							<button class="contact100-form-btn" name='btn-pass'>
								<span>
									Change Password
